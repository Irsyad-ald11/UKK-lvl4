...
<body class="bg-slate-50 text-slate-800 min-h-full font-sans antialiased flex flex-col m-0 p-0">
                            ...
                            echo "<tr class='hover:bg-slate-50/80 transition-colors duration-150 text-sm text-slate-700 font-medium'>
                                 ...
                                 <td class='px-6 py-4'>
                                     <div class='flex items-center justify-center gap-3'>
                                         <a href='./update.php?id={$data['id']}' class='text-xs font-bold bg-slate-100 hover:bg-slate-200 text-slate-700 py-1.5 px-3 rounded-lg transition-colors border border-slate-200/40'>
                                             Edit
                                         </a>
                                         <a href='./delete.php?id={$data['id']}' onclick=\"return confirm('Yakin ingin hapus?')\" class='text-xs font-bold bg-red-50 hover:bg-red-100 text-red-600 py-1.5 px-3 rounded-lg transition-colors border border-red-100/40'>
                                             Hapus
                                         </a>
                                     </div>
                                 </td>
    ...
    <footer class="mt-auto shrink-0 w-full bg-slate-900 text-slate-300 border-t border-slate-800/80">
        ...
        <div class="mt-2 py-4 flex-col text-center text-xs text-slate-400 tracking-wide">
            <p class="text-md font-medium">&copy; 2026 <span class="text-slate-500">Ahmad Irsyad ald</span></p>
        </div>
        </div>
    </footer>
